...
<html lang="ko">
  ...
  <body>
    ...
    <main>
      ...
      <h2>Team progress</h2>
      <div class="table">
        <div class="row head"><span>Name</span><span>Role</span><span>Progress</span><span>Current ownership</span></div>
        <div class="row"><span>Codex</span><span>Lead Architect</span><strong>22%</strong><span>Architecture, integration, progress tracking</span></div>
        <div class="row"><span>James</span><span>Product / Policy / Copy</span><strong>32%</strong><span>Benchmark audit, policy, copy</span></div>
        <div class="row"><span>Poincare</span><span>Mobile App</span><strong>22%</strong><span>Flutter-ready app screens and mock flow</span></div>
        <div class="row"><span>Dalton</span><span>Backend/API</span><strong>18%</strong><span>Mobile, admin, and homepage API planning</span></div>
        <div class="row"><span>Mason</span><span>Admin Frontend</span><strong>12%</strong><span>Admin web ownership and route standards</span></div>
        <div class="row"><span>Lena</span><span>Homepage Frontend</span><strong>36%</strong><span>Public website pages and Next.js skeleton</span></div>
        <div class="row"><span>Carver</span><span>QA / Release</span><strong>24%</strong><span>QA matrix, release readiness, blockers</span></div>
      </div>

      <h2>Area progress</h2>
      <div class="table compact">
        <div class="row head"><span>Area</span><span>Progress</span><span>Status</span></div>
        <div class="row"><span>Overall</span><strong>58%</strong><span>Artifact-backed project readiness</span></div>
        <div class="row"><span>Project setup</span><strong>50%</strong><span>Monorepo docs, principles, roles, and naming initialized</span></div>
        <div class="row"><span>Product planning</span><strong>32%</strong><span>MVP scope, policies, and benchmark audit drafted</span></div>
        <div class="row"><span>Mobile app</span><strong>79%</strong><span>Flutter app, Android debug APK, REST preview mode, and iOS IPA build path prepared</span></div>
        <div class="row"><span>Backend API</span><strong>18%</strong><span>API planning and support/content modules drafted</span></div>
        <div class="row"><span>Admin web</span><strong>12%</strong><span>Admin ownership and worklist documented</span></div>
        <div class="row"><span>Homepage web</span><strong>36%</strong><span>Pages, shell, package/config, sitemap, robots, and status page created</span></div>
        <div class="row"><span>QA and release</span><strong>24%</strong><span>Verification rules, smoke checklist, and blocker register added</span></div>
      </div>
